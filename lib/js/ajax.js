...
AJAX.JS
======================================================
Petite librairie Javascript permet de faire des requêtes AJAX simplement

SOURCES
======================================================
Auteur : marcosbl@gmail.com
URL : https://code.google.com/p/miniajax/
...
ajax.serialize=function(f){
    ...
    var nv=function(e){
        if(e.name)
            return encodeURIComponent(e.name)+'='+encodeURIComponent(e.value);else return ''
    };
